...
with program.tabbedFrame("MainTabs"):
    ...
    with program.tab("Welcome!"):
        program.setPadding(10, 10)
        program.addLabel("welcome", "Welcome to your")
    ...
    with program.tab("Applications"):
        with program.labelFrame("Applications"):
            ...
            with program.labelFrame("Performance to Battery Life Selector", 1, 1):
                program.setPadding(10, 10)
                ...
                program.addButton("Performance to Battery Life", PerfBattery, 0, 1)
